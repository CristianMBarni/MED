...
Md_guess = GOR_guess*Ms; % Equation invented randomly, needs reviewing
...
F_total = Md_guess*Xbn_max/(Xbn_max - Xsw); % Equation invented randomly, needs reviewing
%     if parallel_feed
F(1:n) = F_total/n;
%     elseif forward_feed
%
...
if Ratio_Qdc < 1.08
    error('Condensator ratio of heat is too low')
end
if Ratio_Qdc > 2.5
    warning('Condensator ratio of heat is too high')
end
